<div class="card border-0">
    <div class="card-body">
        ...
        <hr>
        <div>
            <form action="{{ route('admin.berita.store') }}" method="POST" id="form-berita">
                @csrf
                <div class="mb-4">
                    <label for="judul-berita" class="form-label">Judul Berita</label>
                    <input type="text" class="form-control" placeholder="..." name="judul-berita" id="judul-berita">
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <label for="konten-berita" class="form-label">Konten</label>
                        <textarea name="konten-berita" id="konten-berita" class="form-control" rows="30"></textarea>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-4">
